...
import ms_pred.gnn_pred.train as gnn_train
import ms_pred.gnn_pred.gnn_data as gnn_data
import ms_pred.gnn_pred.gnn_model as gnn_model
...
def get_args():
    ...
    gnn_train.add_gnn_train_args(parser)
